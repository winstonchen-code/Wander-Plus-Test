    ...
    return (
        <Wrapper>
            <form onSubmit={props.handleSubmit}>
                <Headline>Have an experience with {props.attributes.city}? Share your review!</Headline>
                <Field>
                ...
                <Field>
                    <RatingContainer>
                        <RatingTitle className="rating-title-text">Rate This Location</RatingTitle>
                        <RatingBox>
                            {ratingOptions}
                        </RatingBox>
                    </RatingContainer>
